...
Payment: Please pay via PayNow to mobile no. 9018 1742 and reference your payment as "bakery goods".
...
function WhatsAppMessageSheet({
  ...
  const handleSend = () => {
    ...
    window.open(`whatsapp://send?phone=65${whatsappNumber}&text=${encoded}`);
  };
  ...
  return (
    <>
      <div className="flex items-center gap-1 mt-2">
        ...
        <a
          href={`whatsapp://send?phone=65${whatsappNumber}`}
          target="_blank"
